...
#define	VB_INIT0		-3 //init
#define	VB_INIT1		-2 //init
#define	VB_TRUE			-1
#define	VB_FALSE		0

#define FM2VID 0xd4d
#define FM2PID 0x33
//static GUID FIELDMAXII_GUID = {3F1BF071-69CE-425a-B482-1262C68D2078};
//static GUID FIELDMAXII_GUID = {0x3F1BF071-0x69CE-0x425a-0xB482-0x1262C68D2078};
static GUID FIELDMAXII_GUID = {0x3F1BF071, 0x69CE, 0x425a, 0xB4, 0x82, 0x12, 0x62, 0xC6, 0x8D, 0x20, 0x78};
//
