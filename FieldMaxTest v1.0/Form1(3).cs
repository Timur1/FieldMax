...
namespace FieldMaxTest
{
    public partial class Form1 : Form
    {
        ...
        {
            listBox1.Items.Add(DateTime.Now.ToLongTimeString() + "          " + serialNumber + " " + lastFault);
        ...
        public void ProbeRemovedHandler(string serialNumber)
        {
            ...
            listBox1.Items.Add(DateTime.Now.ToLongTimeString() + "          " + temp);
            listBox1.TopIndex = listBox1.Items.Count - 1;
            if (DataFile != null)
                DataFile.Flush();
        ...
        public void NotifyMeterAddedHandler(string serialNumber, string deviceIndex)
        {
            ...
            listBox1.Items.Add(DateTime.Now.ToLongTimeString() + "          " + serialNumber + " MeterAdded ");       
            listBox1.TopIndex = listBox1.Items.Count - 1;
        }
        ...
        public void NotifyMeterRemovedHandler(string serialNumber, string deviceIndex)
        {
            ...
            if ((DataFile != null)&&(timer1.Enabled))
                DataFile.Flush();
            button_Start.Enabled = false;
            listBox1.Items.Add(DateTime.Now.ToLongTimeString() + "          " + serialNumber + "MeterRemoved ");
            listBox1.TopIndex = listBox1.Items.Count - 1;
        }
        ...
        private void NotifyZeroDisplayZeroDeviceProgressToClientHandler(short zeroDeviceTimeoutCounter)
        {
            ...
            if (zeroDeviceTimeoutCounter == -1)
            {
                ...
                listBox1.Items.Add(DateTime.Now.ToLongTimeString() + "          " + "Zero fail " + selectedDeviceComboBox1.serialNumber);
                ZeroButton.Text = "Zero";
                listBox1.TopIndex = listBox1.Items.Count - 1;
            }
        }
        ...
        private void button_Start_Clicked(object sender, EventArgs e)
        {
            if (button_Start.Text == "Start")
            {
                ...
                button_ExportData.Enabled = false;
                listBox1.Items.Add(DateTime.Now.ToLongTimeString() + "          " + "Experiment started");
                listBox1.TopIndex = listBox1.Items.Count - 1;
            }
            else
            {
                ...
                listBox1.Items.Add(DateTime.Now.ToLongTimeString() + "          " + "Experiment stopped");
                listBox1.Items.Add(DateTime.Now.ToLongTimeString() + "          " + "Points " + allData.Count);
                listBox1.TopIndex = listBox1.Items.Count - 1;
            }
        ...
        private void BackLight_Click(object sender, EventArgs e)
        {
            ...
            if (selectedDeviceComboBox1.serialNumber != null && buttonLight.Text == "Light up")
            {
                engine.m_DevicesList.Item(selectedDeviceComboBox1.deviceIndex).BacklightCommand(true);
                buttonLight.Text = "Shade";
                return;
            }
            if (selectedDeviceComboBox1.serialNumber != null && buttonLight.Text == "Shade")
            {
                engine.m_DevicesList.Item(selectedDeviceComboBox1.deviceIndex).BacklightCommand(false);
                buttonLight.Text = "Light up";
                return;
            }
        }
        ...
        private void button_ExportData_Click(object sender, EventArgs e)
        {
            if (folderBrowserDialog1.SelectedPath == "")
                SaveFile = new StreamWriter(textBox_FileName.Text, true);
            else
            ...
            {
                SaveFile.WriteLine(string.Format("{0,4}\t{1,4}", p.X, p.Y));
            }
            SaveFile.Close();
            listBox1.Items.Add(DateTime.Now.ToLongTimeString() + "          " + "File saved " + folderBrowserDialog1.SelectedPath + "\\" + textBox_FileName.Text);
            listBox1.TopIndex = listBox1.Items.Count - 1;
        }
    }
}
